...
<head>
  ...
  <link href="{{asset('/customAuth/trainer/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create an Trainer Account!</h1>
              </div>
              <form class="user" method="POST" action="{{ route('register') }}">
                        @csrf
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                  <input hidden type="text" name="trainer" value="1">
