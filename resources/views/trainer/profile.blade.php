                        ...
                        <div class="modal-dialog">
                             ...
                             <div class="modal-header">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" >&times</button>
                                        ...
                                        <form class="text-left border border-light p-2" method="POST" action="{{route('trainer.changePassPost')}}">
                             ...
                             <div class="modal-header">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" >&times</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="text-left border border-light p-5" method="POST" action="{{ route('trainer.storeprofile') }}" enctype="multipart/form-data">
                                                 @csrf
                                                      <div class="form-group">
                                                        <input type="text" name="id" value="{{$trainers->id}}" hidden/>
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              ...
              <a href="{{route('trainer.profileGet')}}" class="dropdown-item">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="{{$trainers->profileimage}}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>{{ $trainers->email }}
                </div>
                <div>
                </div>
              </div>
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('trainer.profilePost') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="id" value="{{$trainers->id}}" hidden/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control form-control-alternative" readonly value="{{ $trainers->email }}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="age" class="form-control form-control-alternative"  value="{{$trainers->age}}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Phone</label>
                        <input type="text" name="phone" class="form-control form-control-alternative"  value="{{$trainers->phone}}">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input name="address" class="form-control form-control-alternative"  value="{{$trainers->address}}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <input type="text" id="dbgender" value="{{$trainers->gender}}" hidden>

                  </div>
                </div>

                <div class="form-group">
                            <img id="preview_n_id" src="{{$trainers->n_id}}" style="max-width:68px; margin-top:10px;"/><br><br>
                            <label for="exampleInputPassword1">Curriculum Vitae</label><br>
                            <input  type="file" name="n_id"  onchange="n_id_view(this)"/>
                </div>
                <hr class="my-4" />
                <input type="submit"  class="btn btn-success float-right" value="Update"/>
              </form>
